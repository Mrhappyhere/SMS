	<nav class="ts-sidebar">
			...
			<li><a href="userlist.php"><i class="fa fa-users"></i> Student List</a>
			</li>
			...
			<li><a href="download.php"><i class="fa fa-download"></i> &nbsp;Download Students-List</a>
			</li>
			</ul>
			<p class="text-center" style="color:#ffffff; margin-top: 100px;">© MrHappy</p>
		</nav>
